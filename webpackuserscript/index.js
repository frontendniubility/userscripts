        ...
        compiler.hooks.emit.tapPromise(PLUGIN_NAME, async compilation => {
            ...
            for (const chunk of compilation.chunks) {
                ...
                for (const file of chunk.files) {
                    ...
                    // prepend header
                    compilation.assets[outputFile] = new ConcatSource(headerString, '\n', fileSource);
                    ...
                    if (this.options.metajs) {
                        compilation.assets[metaFile] = new RawSource(this.options.proxyScript.enable ? hotDevHeaderString : headerString);
                    }
                }
            }
        });
