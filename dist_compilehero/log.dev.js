...
var format = winston.format,
    transports = winston.transports; // const { combine, metadata, timestamp, label, prettyPrint, printf, colorize, padLevels } = format;
...
var logopt = {
  ...
  // format.padLevels(),
  // format.prettyPrint(),
  format.splat(), // format.uncolorize(),
  format.simple(), format.printf(function (info) {
    var level = info.level,
        message = info.message,
        label = info.label,
        timestamp = info.timestamp; // console.log(info);
