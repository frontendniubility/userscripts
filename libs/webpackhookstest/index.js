											...
											compilationHook.tap(
												...
												function (module) {
													...
													if (className(module) === 'NormalModule') {
														logger.cnrun(`${''.padEnd(p1)} cnkey> ${cnKey.padEnd(p2)} crkey> ${_crKey.padEnd(p3)} > ${compilation.__objectId()}    > ${compilationHook._args != null ? 'args:  ' + compilationHook._args.join(', ') : 'null'} `);
														// console.log(module);
													} else {
