 ...
 * @param func 
 */
export function getorAddSession<T>(key: string, func: function | T): T;
 ...
 */
export function getTeacherInfoFromDetailPage(tinfo_saved: TeacherInfo, jqr: JQuery<Document>, tinfo_latest: TeacherInfo): TeacherInfo
/**
 * 提交一个函数到全局的执行队列,func中必须调用next()方法进行执行队列中的下一个函数
 */
export function submit(func: function): void;

declare type TypeOfKey = "表情丰富" | "耐心讲解" | "善于鼓励" | "适当纠错" | "善用教具" | "拓展知识点" | "善于举例" | "易于理解" | "有问必答" | "发音标准" | "环境专业" | "装饰特效" | "衣着得体" | "会说中文";
