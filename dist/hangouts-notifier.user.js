...
(() => {
    var __webpack_modules__ = {
        ...
        485: () => {
            ...
            var util = {
            ...
            }, SCRIPT_NAME = "Hangouts Notifier", LAST_MESSAGE = ".tk.Sn", MESSAGE_TEXT = ".Mu:last-child", USER_IMAGE = "img.Yf", NEW_MSG = ".Ik.uB", CHECK_INTERVAL = 1 * 1e3, NOTIFY_HIDE_DELAY = 6 * 1e3, NOTIFY_EXPIRE = 1 * 60 * 1e3, hn = {
                ...
                notification: function notification(title, opt) {
                    var n = new Notification(title, opt), id = setTimeout((function() {
                        n.close();
                    }), NOTIFY_EXPIRE);
                    n.onclick = function() {
                        clearTimeout(id);
                ...
                start: function start() {
                    ...
                    var lastId = null, res = hn.getLastMessage();
                    if (!res) {
    ...
    (() => {
        __webpack_require__.hmrF = () => "hangouts-notifier_user." + __webpack_require__.h() + ".hot-update.json";
    })();
    (() => {
