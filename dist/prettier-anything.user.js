...
(() => {
    var __webpack_modules__ = {
        ...
        4819: () => {
            ...
            var p = function p() {
            ...
            }, loaded = false, load = function load() {
                if (loaded) return;
                loaded = true;
                ...
                var _ref = _asyncToGenerator(regeneratorRuntime.mark((function _callee(clip) {
    ...
    (() => {
        __webpack_require__.hmrF = () => "prettier-anything_user." + __webpack_require__.h() + ".hot-update.json";
    })();
    (() => {
    ...
    var __webpack_exports__ = __webpack_require__(4819);
})();