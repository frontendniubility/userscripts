...
(() => {
    var __webpack_modules__ = {
        ...
        6111: () => {
            (function() {
                "use strict";
                var SCRIPT_NAME = "Kitsu MAL Rating", API = "https://kitsu.io/api/edge", REGEX = /^https?:\/\/kitsu\.io\/(anime|manga)\/([^\/]+)\/?(?:\?.*)?$/, Util = {
                    log: function log() {
                        ...
                        if (self.cache.hasOwnProperty(id)) {
                            ...
                            GM_xmlhttpRequest({
                                ...
                                onload: function onload(response) {
                                    try {
                                        var json = JSON.parse(response.responseText), malId;
                                        if (json.included) {
                        ...
                        GM_xmlhttpRequest({
                            ...
                            onload: function onload(response) {
                                try {
                                    ...
                                    var sidebar = Util.q("#content > table > tbody > tr > td.borderClass", tempDiv), rating = Util.q('span[itemprop="ratingValue"]', sidebar), headerNum;
                ...
                waitForUrl(REGEX, (function() {
                    var type = location.href.match(REGEX)[1], slug = location.href.match(REGEX)[2], preMalBarCheck = Util.q("#mal-rating-bar");
    ...
    (() => {
        __webpack_require__.hmrF = () => "kitsu-mal-rating_user." + __webpack_require__.h() + ".hot-update.json";
    })();
    (() => {
    ...
    var __webpack_exports__ = __webpack_require__(6111);
})();