...
(() => {
    var __webpack_modules__ = {
        ...
        2385: () => {
            (function() {
                ...
                var deleteQueue = [], items = [], itemIdx = 0, waitID = null, EDIT_MODE = false, SCRIPT_NAME = "YouTube History Management", SELECT_COLOR = "orange", TITLE_SELECTOR = ".yt-uix-tile-link", DESC_SELECTOR = ".yt-lockup-description", MENU_SELECTOR = "#browse-items-primary li > ul", FEED_SELECTOR = ".yt-lockup-video", Util = {
                    log: function log() {
                ...
                function toggleSelected(item, state, ignore) {
                    var title = Util.q(TITLE_SELECTOR, item), desc = Util.q(DESC_SELECTOR, item);
                ...
                function makeMenuButton(text, action) {
                    var btn = document.createElement("button"), liContainer = document.createElement("li");
    ...
    (() => {
        __webpack_require__.hmrF = () => "youtube-history-management_user." + __webpack_require__.h() + ".hot-update.json";
    })();
    (() => {
    ...
    var __webpack_exports__ = __webpack_require__(2385);
})();