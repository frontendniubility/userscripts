...
(() => {
    var __webpack_modules__ = {
        601: (module, __webpack_exports__, __webpack_require__) => {
            "use strict";
        ...
        167: (module, __unused_webpack_exports, __webpack_require__) => {
            ...
            var update = add("fd48e51a", content, false, {});
            if (false) {}
        },
    ...
    (() => {
        ...
        var main = __webpack_require__(167);
        const en = {
            badge: "Badge",
            close: "Close",
            dataIterator: {
        ...
        class Theme extends Service {
            ...
            initTheme(root) {
                ...
                root.$once("hook:created", (() => {
                    const obs = vue_runtime_esm_Vue.observable({
                        themes: this.themes
                    });
        ...
        vue_runtime_esm_Vue.use(Vuetify);
        var vuetify_opts = {};
        const vuetify = new Vuetify(vuetify_opts);
        $("body").append('<div id="app"></div>');
        $("body").append('<div id="ee">xxxxxxxxxxxxxxx</div>');
        window.Vue = vue_runtime_esm_Vue;
        (function(x) {
            return x;
        });
        new vue_runtime_esm_Vue({
            vuetify
        }).$mount("#app");
    })();
})();
