...
(() => {
    var __webpack_modules__ = {
        ...
        1976: () => {
            ...
            var SCRIPT_NAME = "YouTube Playlist Search", ITEM_SELECTOR = "#contents > ytd-playlist-video-renderer,ytd-grid-video-renderer", ITEM_PROGRESS_SELECTOR = ITEM_SELECTOR + " #progress", TEXT_SELECTOR = "#meta", OFFSET_AREA_SELECTOR = "#masthead-container", util = {
                log: function log() {
                ...
                render: function render() {
                    var commonStyles = [ "position: fixed", "top: ".concat(util.q(OFFSET_AREA_SELECTOR).clientHeight, "px"), "z-index: 9000", "padding: 5px 8px", "border: 1px solid #999", "font-size: medium", "color: var(--yt-primary-text-color)", "margin: 0", "box-sizing: border-box", "background: var(--yt-main-app-background-tmp)" ], txtSearch = util.makeElem("input", {
                        type: "text",
                ...
                search: function search() {
                    var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "", invert = query.startsWith("^");
                    ...
                    var count = yps._items.map((function(item) {
                        var hideBecauseWatched = yps.hideWatched && item.watched, hide = hideBecauseWatched || !query[invert ? "some" : "every"]((function(q) {
                    ...
                    waitForUrl(/^https:\/\/www\.youtube\.com\/(playlist\?list=|(user|channel)\/[^\/]+\/videos|feed\/subscriptions).*/, (function() {
                        ...
                        var playlistUrl = location.href, _yps$render = yps.render(), txtSearch = _yps$render.txtSearch, resultCount = _yps$render.resultCount, refresh = util.debounce((function() {
                            ...
                            onmatch: function onmatch(prog) {
                                ...
                                if (!watched) return;
                                var itemElem = prog.closest(ITEM_SELECTOR), found = yps._items.find((function(item) {
    ...
    (() => {
        __webpack_require__.hmrF = () => "youtube-playlist-search_user." + __webpack_require__.h() + ".hot-update.json";
    })();
    (() => {
    ...
    var __webpack_exports__ = __webpack_require__(1976);
})();